...
$basePath = "d:\OneDrive - Vaal University of Technology\WORK\2026\AI_v2\Week 12 - Final Project & Presentation"
$files = @(
    "Week_12_Project_Recommender.md",
    "Week_12_Project_Forecasting.md"
)

foreach ($file in $files) {
    $fullPath = Join-Path $basePath $file
    Add-Content -Path $fullPath -Value $grid -NoNewline
}
